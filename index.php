...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.php">Find Your Job</a>
...
if(isset($_POST['search'])){
   echo $keyword=$_POST['key'];
   echo $category=$_POST['category'];
   //$company=$_POST['company'];
 $query2 = mysqli_query($conn,"SELECT * FROM all_jobs WHERE keyword LIKE '%$keyword%' OR category='$category' "); 
}
else{
  $query2= mysqli_query($conn,"SELECT * FROM all_jobs ORDER BY job_id DESC");
  //echo $query;
}
...
while($row=mysqli_fetch_array($query2)){?> 
            ...
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
                ...
                <div class="job-post-item-body d-block d-md-flex">
                  <div class="mr-3"><span class="icon-layers"></span><?php echo $row['des'];?></a></div>
        ...
        <div class="row mb-5">
        	<div class="col-md">
             <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Project Members</h2>
              <p>
              <ul class="list-unstyled">
                <li><a href="#" class="py-2 d-block">Trina Chakraborty - 2017331041</a></li>
                <li><a href="#" class="py-2 d-block">Ayesha Afroze - 2017331012</a></li>
                <li><a href="#" class="py-2 d-block">CSE,2017-18 </a></li>
                <li><a href="#" class="py-2 d-block">SUST</a></li>
              </ul>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">First Ladies Hall, SUST, Sylhet</span></li>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This project is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="#" target="_blank">Team_Amigos</a>
